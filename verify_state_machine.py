...
def verify():
    ...
    EXPENSES_CLOSED['Jednostka A'] = True
    EXPENSES_CLOSED['Jednostka B'] = True
    print(f"Office1 Closed: {EXPENSES_CLOSED['Jednostka A']}")
    assert EXPENSES_CLOSED['Jednostka A'] is True
    ...
    print(f"Office1 Closed: {EXPENSES_CLOSED['Jednostka A']}")
    assert EXPENSES_CLOSED['Jednostka A'] is False
    assert EXPENSES_CLOSED['Jednostka B'] is False
